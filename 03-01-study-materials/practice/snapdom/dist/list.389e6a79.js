...
var patch = (0, _snabbdom.init)([_style.default, _eventlisteners.default, _class.default, _props.default]);
var vnode;
var sortBy = 'rank';
var originalData = [{
  rank: 1,
...
var data = [originalData[0], originalData[1], originalData[2]];
...
function listView(item) {
  ...
  }, [(0, _snabbdom.h)('div', item.title), (0, _snabbdom.h)('div', item.desc)]);
}

function view(items) {
  return (0, _snabbdom.h)('div', [(0, _snabbdom.h)('h1', 'Top 10 movies'), (0, _snabbdom.h)('span', [(0, _snabbdom.h)('a.btn.rank', {
    class: {
      active: sortBy === 'rank'
    },
    on: {
  ...
  }, 'Description')]), (0, _snabbdom.h)('div.list', {}, items.map(listView))]);
}
